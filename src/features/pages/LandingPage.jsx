  ...
  return (
    <>
      ...
      <div className="bg-slate-800 grid grid-cols-3">
        {/* Content explaining about creating recipes / searching recipes / viewing table about fat/protein/carbs/calories */}
      </div>
      <div className="bg-white grid grid-cols-3">
        {/* Content explaining about scheduling recipes to your google maps and getting shopping lists */}
      </div>
    </>
  );
};
